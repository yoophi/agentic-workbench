...
**Constraints**: Must not break existing selection, annotation, Mermaid, code block, auto reload, or AW prompt send flows. Must preserve app-to-app isolation and avoid adding shared UI before interaction contracts converge.
...
- [contracts/quick-prompt-ui.md](./contracts/quick-prompt-ui.md)
